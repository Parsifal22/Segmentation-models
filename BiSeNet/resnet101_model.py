...
class ContextPath(nn.Module):
    def __init__(self, backbone):
        ...
        # Get the output channels of the backbone's layers
        if isinstance(backbone, nn.Module):
            # Update output channels for ResNet101
            self.in_channels_16 = 1024  # ResNet101's layer3 output channels
            self.in_channels_32 = 2048  # ResNet101's layer4 output channels
        ...
        # Output conv layers
        self.conv_head8 = ConvBlock(512, 128)
...
class BiSeNet(nn.Module):
    def __init__(self, num_classes=1):
        ...
        # Initialize ResNet18 backbone with proper weights
        backbone = resnet18(weights=ResNet101_Weights.IMAGENET1K_V1)
